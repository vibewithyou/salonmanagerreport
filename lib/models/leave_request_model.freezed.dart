...
class _$LeaveRequestImpl implements _LeaveRequest {
  ...
  @override
  String toString() {
    return 'LeaveRequest(id: $id, employeeId: $employeeId, employeeName: $employeeName, type: $type, startDate: $startDate, endDate: $endDate, reason: $reason, status: $status, adminNotes: $adminNotes, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
