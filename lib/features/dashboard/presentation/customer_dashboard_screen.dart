  ...
  Widget _buildQuickActionsGrid(BuildContext context) {
    final actions = [
      ...
      _QuickAction(
        ...
        label: 'Salons in der Nähe',
        color: AppColors.rose,
        onTap: () => context.go('/salon-map-search'),
      ),
      _QuickAction(
        icon: LucideIcons.list,
        label: 'Salon-Liste',
        color: AppColors.sage,
        onTap: () => context.go('/salon-list-search'),
      ),
      _QuickAction(
  ...
  Widget _buildAppointmentsList(
    ...
    return Column(
      children: appointments.map((apt) {
        // Convert dynamic to AppointmentSimple if needed
        if (apt is AppointmentSimple) {
